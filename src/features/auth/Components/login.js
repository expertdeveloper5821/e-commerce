...
// console.log(errors);
  ...
  <div className="flex-1 flex-col justify-center px-6 py-12 max-w-sm mx-auto border-gray-900 border-2 shadow-md p-4 rounded-md">
    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm ">
        ...
        <p className="mt-10 text-center text-sm text-white">
          Not a member?{' '}
          <Link to='/signup' className="font-semibold leading-6 text-indigo-900 hover:text-indigo-500">
            Create an Account
          </Link>
        </p>
      </div>
